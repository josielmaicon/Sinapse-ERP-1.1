...
from .routers import products, financeiro, rotinas, clientes, configuracoes, usuarios, vendas, pdvs, fiscal, solicitacoes, historico, crediario, impressao, promocoes, auth, notas_entrada
