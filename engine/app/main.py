...
from .routers import products, financeiro, clientes, configuracoes, usuarios, vendas, pdvs, fiscal, solicitacoes, historico, crediario, impressao, promocoes, auth, notas_entrada
